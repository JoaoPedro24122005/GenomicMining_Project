...
[1-3]. While these enzymes are essential for eco-friendly catalysis, standard mesophilic enzymes often lack the 
...
2.2.1 Structure of the assembly table (GTDB) - The assembly from GTDB contains information about:
...
2.2.2 Structure of the assembly table (NCBI) - The assembly from NCBI contains informaation about:
